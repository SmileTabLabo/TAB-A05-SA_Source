...
#else
	/* Configure INT pin */
	{REG_TX_INT_CTRL, 0xC0, B_TX_INTPOL_ACTL | B_TX_INT_PUSHPULL},
	/* Disable interrupts */
	{REG_TX_INT_MASK1, 0xFF, 0xFF},
	{REG_TX_INT_MASK2, 0xFF, 0xFF},
	{REG_TX_INT_MASK3, 0xFF, 0xFF},
	/* Clear interrupts */
	{REG_TX_INT_CLR0, 0xFF, 0xFF},
	{REG_TX_INT_CLR1, 0xFF, 0xFF},
	{REG_TX_SYS_STATUS, 0x03, 0x03},
	/* Enable interrupts */
	{REG_TX_INT_MASK1, 0xFF, ~(B_TX_RXSEN_MASK | B_TX_HPD_MASK)},
	{REG_TX_INT_MASK2, 0xFF,
	 ~(B_TX_KSVLISTCHK_MASK | B_TX_AUTH_DONE_MASK | B_TX_AUTH_FAIL_MASK)},
...
/* //////////////////////////////////////////////////////////////// */
	...
	HDMITX_WriteI2C_Byte(0xE3, 0x01);
...
//	AudioFormat |= 0x01; /* mingchih add */
	...
	if (bSPDIF)
		HDMITX_WriteI2C_Byte(REG_TX_AUDIO_CTRL3, B_TX_CHSTSEL | 0x01);
	else
		HDMITX_WriteI2C_Byte(REG_TX_AUDIO_CTRL3, 0 | 0x01);
