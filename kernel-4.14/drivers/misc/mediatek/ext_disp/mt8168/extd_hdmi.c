...
#if 1
		if (((hdmi_reschange - 2) == HDMI_VIDEO_1920x1080p_30Hz)
		    || ((hdmi_reschange - 2) == HDMI_VIDEO_2160p_DSC_30Hz))
#else
...
#if 1
		else if (((hdmi_reschange - 2) == HDMI_VIDEO_1920x1080p_24Hz)
		    || ((hdmi_reschange - 2) == HDMI_VIDEO_2160p_DSC_24Hz))
#else
		else if (hdmi_reschange == HDMI_VIDEO_2160p_DSC_24Hz)
#endif
			hdmi_info.vsyncFPS = 2400;
		else if (hdmi_reschange == HDMI_VIDEO_1920x1080p_25Hz)
			hdmi_info.vsyncFPS = 2500;
		else
