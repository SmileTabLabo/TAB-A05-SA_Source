...
#define ISP_REG_ADDR_EN_P1_DMA_D (ISP_ADDR + 0x14)
...
/* CAM_CTL_EN_P1_DMA_D */
#define ISP_REG_P1_DMA_D_AFO_D_EN			(0x00000008)
...
void ISP_set_AFO_D_EN(int en)
{
	unsigned int Reg;
	unsigned int setReg;

	Reg = ISP_RD32(ISP_REG_ADDR_EN_P1_DMA_D);
	if (en) {
		setReg = Reg | ISP_REG_P1_DMA_D_AFO_D_EN;
	}
	else {
		setReg = Reg & ~ISP_REG_P1_DMA_D_AFO_D_EN;
	}
	ISP_WR32(ISP_REG_ADDR_EN_P1_DMA_D, setReg);
}
