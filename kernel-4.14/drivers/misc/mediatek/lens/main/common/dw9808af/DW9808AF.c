...
static int s4DW9808AF_ReadReg(unsigned short *a_pu2Result)
{
...
#if 0
	{	// [FIXME] カメラAFが効かない件の暫定対応
		extern void ISP_set_AFO_D_EN(int en);
		ISP_set_AFO_D_EN(1);
	}
#endif
}
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4DW9808AF_ReadReg(&InitPos);
