...
//		.stream_name = "TDM_Playback",
	...
	[DAI_LINK_I2S_INTF] = {
		...
		.cpu_dai_name = "I2S",
		.no_pcm = 1,
#ifdef CONFIG_SND_SOC_TAS2505
		.codec_name = "odm:tas2505_x2",
		.codec_dai_name = "tas2505_x2-hifi",
#else  /* !CONFIG_SND_SOC_TAS2505 */
		.codec_name = "snd-soc-dummy",
		.codec_dai_name = "snd-soc-dummy-dai",
#endif /* !CONFIG_SND_SOC_TAS2505 */
